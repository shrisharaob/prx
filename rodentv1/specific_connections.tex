\section{\label{sec:specific_con}Adding specific connections}
...
\end{eqnarray}
Since the connection probability must be in the interval $[0, 1]$, the parameter $\kappa$ should satisfies the condition $0 \leq \kappa \leq \frac{\sqrt{K}}{2}$.\\ %Therefore, in the limit $K \rightarrow \infty$, the upper bound for  $\kappa$ approaches $\infty$ as $\sqrt{K}$\@. \\
...
\begin{figure}
\includegraphics[scale=1]{./figs/mE1_vs_kappa}% Here is how to import EPS art
