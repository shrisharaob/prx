...
\qquad&& \left. \left. \PopAvg{u^i_A(\phi - \Delta, t)- \PopAvgDPhi{u^i_A(\phi - \Delta, t)}}{t} \right]_{\delta \phi} \right\rbrace \\ %\left\lbrace \PopAvgDPhi{ \PopAvg{u^i_A(\theta + \Delta, t) - \PopAvgDPhi{u^i_A(\theta + \Delta, t)}}{t}} \right. \right. \nonumber \\
...
% \begin{eqnarray}
% \label{stabme0}
% \frac{1}{\sqrt{\alpha_E}} \left(1 - \uEZero - \uOne \costh \right)  =&& A_0 + \mEOne (A_1 - \avar \costh) + \left( \mEOne \right)^2 A_2 + \left( \mEOne \right)^3 A_3 + \mathcal{O} \left( (\mEOne)^4 \right) \\
